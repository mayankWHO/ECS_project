...
class TestNewWidget extends StatefulWidget {
  const TestNewWidget({super.key});

  static String routeName = 'testNew';
  static String routePath = '/testNew';
              ...
              child: Column(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      _model.medicineList = [];
                      _model.addToMedicineList(<String, String?>{
                        'name': _model.textController3.text,
                        'compartment': _model.textController4.text,
                      });
                      _model.addToMedicineList(<String, String?>{
                        'name': _model.textController5.text,
                        'compartment': _model.textController6.text,
                      });
                      _model.addToMedicineList(<String, String?>{
                        'name': _model.textController7.text,
                        'compartment': _model.textController8.text,
                      });

                      await MedicationsRecord.collection.doc().set({
                        ...createMedicationsRecordData(
                          userID: currentUserUid,
                          hour: int.tryParse(_model.textController1.text),
                          minute: int.tryParse(_model.textController2.text),
                          session: _model.session,
                        ),
                        ...mapToFirestore(
                          {
                            'createdAt': FieldValue.serverTimestamp(),
                            'medicines': _model.medicineList
                                .map((e) => e.toString())
                                .toList(),
                          },
                        ),
